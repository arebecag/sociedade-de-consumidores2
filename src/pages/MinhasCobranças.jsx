...
export default function MinhasCobranças() {
  ...
  const loadCobranças = async (partnerId) => {
    setLoading(true);
    try {
      const data = await base44.entities.Financeiro.filter(
        { userId: partnerId },
        "-created_date",
        20,
      );
        ...
        action={
          <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
            <Button
              onClick={loadData}
              variant="outline"
              className="border-zinc-700 text-zinc-400 hover:text-white rounded-xl gap-2 w-full sm:w-auto"
            >
                      ...
                      <div className="flex flex-col gap-2 min-w-[140px]">
                        ...
                        {c.bankSlipUrl && (
                          ...
                          >
                            <Button
                              variant="outline"
                              className="w-full border-zinc-700 text-zinc-300 hover:text-white rounded-xl gap-2 text-sm"
                            >
